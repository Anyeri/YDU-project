...
**1. 구현기능**
  ...
  하지만 본인이 쓴 글 이외의 글은 수정,삭제가 불가능합니다. **게시판(CRUD)과 댓글의(CRUD)** 그리고 **디자인**을 구현했습니다.
  - **수업 공지사항 게시판**
  
  >수업 공지사항 게시판은 **교수자**만 **글 작성,수정,삭제**를 할 수 있습니다. **예외로 관리자는 모든 글 삭제와 댓글 삭제가 가능**합니다.
  - 대나무숲
  - 교수진 평가
