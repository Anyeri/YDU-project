      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="#"><i class="fa fa-caret-right"></i>수업상태 변경</a></li>
              <li><a href="#"><i class="fa fa-caret-right"></i>수강 신청상태 변경</a></li>
              <li><a href="#"><i class="fa fa-caret-right"></i>권한 변경</a></li>
            </ul>
          </li>
          <!-- 대나무숲 관리   -->
          <li class="bamboo">
